...
- [x] `docs/obsidian-vault/00-Index/IMPLEMENTATION-STATUS.md`
- [x] `docs/obsidian-vault/10-PRD/PRD-library-book-tracker.md` (section: User Stories US1, US2)
- [x] `docs/obsidian-vault/20-Features/FEAT-checkout.md` (covers FR-001, FR-005, FR-010)
- [x] `docs/obsidian-vault/40-Functions/FN-Web-Lib-Checkout.md`
- [x] `docs/obsidian-vault/40-Functions/FN-API-Loan-Create.md`
- [x] `docs/obsidian-vault/70-Reference/REF-TechStack.md`
- [x] `docs/obsidian-vault/70-Reference/REF-AuthorizationMatrix.md`
- [x] `docs/obsidian-vault/70-Reference/DesignSystem/DS-Tokens.md`
- [x] `docs/obsidian-vault/70-Reference/DesignSystem/DS-Components.md`
- [ ] `docs/obsidian-vault/60-Flows/FLOW-checkout-counter.md` _ยังไม่มี — flag ใน Doc Gaps_
...
<!-- ดู: standards/STANDARD.md (5-step pipeline), standards/policies/*, docs/obsidian-vault/00-Index/CONSTITUTION.md (ถ้ามี local) -->
...
- `docs/obsidian-vault/00-Index/CONSTITUTION.md` _(if exists; project-specific principles)_
...
- [ ] T032 [FND] รัน load test (k6) — 200 concurrent → confirm p95 ≤ 500 ms — evidence: `docs/obsidian-vault/90-TestPlan/evidence/loan-load-test-<date>.json`
...
- Time taken: <duration>
- Evidence path: `docs/obsidian-vault/90-TestPlan/evidence/<plan-slug>/`
- Handoff: [[HOR-<slug>]]
