...
>   • Re-verify consistency: `/bda-verify --feature <slug>`
...
2. **Pipeline trace** — Understand (Phase 0/1) → Plan (taxonomy filter) → Execute (Phase 2/3) → Verify (Phase 4 affected-docs check)
